...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(tipo, id) {return {tipo:tipo,id:id};};
  var peg$f1 = function(left, right) { return left + right; };
  var peg$f2 = function(digits, decimals) {return parseFloat(digits.join("") + "." + decimals.join(""));};
  var peg$f3 = function(char) {return char;};
  var peg$f4 = function(cadena) {return cadena;};
  ...
  function peg$parseinstrucciones() {
    ...
    s0 = peg$currPos;
    s1 = peg$parsedeclaraciones();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
      s5 = peg$parsedeclaraciones();
      if (s5 !== peg$FAILED) {
        s4 = [s4, s5];
        s3 = s4;
      } else {
  ...
  function peg$parsecomentario_linea() {
    var s0, s1, s2, s3;
